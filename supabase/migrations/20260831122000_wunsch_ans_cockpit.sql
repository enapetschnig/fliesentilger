-- ============================================================================
--  WUNSCH ANS CRM — jede Meldung wandert nach app.epowergmbh.at/wuensche
-- ============================================================================
--
...
-- privaten Bucket und werden bei Bedarf über die Edge Function
-- `wunsch-datei` signiert. Beides über dasselbe gemeinsame Geheimnis.
...
CREATE TABLE IF NOT EXISTS public.cockpit_verbindung (
  ...
  app_key   text NOT NULL DEFAULT 'fliesentilger'
);

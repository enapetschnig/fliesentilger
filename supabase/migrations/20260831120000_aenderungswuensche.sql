-- ============================================================================
--  ÄNDERUNGSWÜNSCHE — Melden direkt aus der App
-- ============================================================================
--
-- Jeder Angemeldete kann von jeder Maske aus melden: Wunsch, Fehler oder
-- Frage — getippt oder als Sprachnachricht, mit Bildschirmfoto und
-- Markierung darauf. Administratoren sehen alles, antworten und setzen den
-- Status.
